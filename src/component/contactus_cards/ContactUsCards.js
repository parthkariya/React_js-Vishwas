        ...
        <div className="Cards_main">
          ...
          <div className="contus-location-list-main">
            ...
            <div className="contus-location-list-flex">
              <button style={{backgroundColor: AllImages === 1 ?"transparent" :"red",color: AllImages === 1 ? "red" : "white"}}
                type="button"
              ...
              <button style={{backgroundColor: AllImages === 2 ?"transparent" :"red",color: AllImages === 2 ? "red" : "white"}}
                type="button"
                className="red_button shop_now_btn"
                onClick={() => {
                  setAllImages(2);
              ...
              <button style={{backgroundColor: AllImages === 3 ?"transparent" :"red",color: AllImages === 3 ? "red" : "white"}}
                type="button"
                className="red_button shop_now_btn"
                onClick={() => {
                  setAllImages(3);
              ...
              <button style={{backgroundColor: AllImages === 4 ?"transparent" :"red",color: AllImages === 4 ? "red" : "white"}}
                type="button"
                className="red_button shop_now_btn"
                onClick={() => {
                  setAllImages(4);
              ...
              <button style={{backgroundColor: AllImages === 5 ?"transparent" :"red",color: AllImages === 5 ? "red" : "white"}}
                type="button"
                className="red_button shop_now_btn"
                onClick={() => {
                  setAllImages(5);
